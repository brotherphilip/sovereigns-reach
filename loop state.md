...
notes: ALL 10 PHASES COMPLETE. Issues resolved: 001-022, 024-030. Shire flash fix iter 66 (LOW). Shire color fix iter 65 (LOW). CityViewScene save+ghost fix iter 64 (MEDIUM). Issue #023 open (LOW): unit movement never executed.
