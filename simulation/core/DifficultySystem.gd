...
const _MODIFIERS := {
	Level.PEACEFUL:   {"ai_threat": 0.3, "tax_income": 1.3, "food_consumption": 0.7},
	Level.NORMAL:     {"ai_threat": 1.0, "tax_income": 1.0, "food_consumption": 1.0},
	Level.HARD:       {"ai_threat": 1.6, "tax_income": 0.85, "food_consumption": 1.25},
	Level.SIEGE_LORD: {"ai_threat": 2.5, "tax_income": 0.7, "food_consumption": 1.5},
}
