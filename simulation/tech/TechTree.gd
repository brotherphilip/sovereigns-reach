...
const TECHS: Dictionary = {
	...
	"crop_tiers": {
		...
		"requires": [],
		"unlocks_buildings": ["wheat_farm", "hops_farm"],
	...
	"farming_speed": {
		...
		"modifiers": {"farm_yield_bonus": 0.2},
		"description": "Farm yield +20%. Faster harvests mean more food per day. Stacks with Advanced Tools.",
	},
	"storage_capacity": {
	...
	"refining_processing": {
		...
		"unlocks_units": [], "unlocks_edicts": [],
		"modifiers": {},
		"description": "Prerequisite for Great Towers and Siege Engines. Unlocks advanced construction and military tiers.",
	},
	"advanced_masonry": {
